...
thecontext.fillRect (150,220,60,h-220);
thecontext.fillStyle = "white";
thecontext.fillText ("2",170,h-20);
thecontext.fillText ("33%",150,h-50);
//chart making
thecontext.fillStyle = "blue";
thecontext.fillRect (250,90,60,h-90);
thecontext.fillStyle = "white";
thecontext.fillText ("3",270,h-20);
thecontext.fillText ("75%",250,h-50);
//chart making
thecontext.fillStyle = "black";
thecontext.fillRect (350,150,60,h-150);
thecontext.fillStyle = "white";
thecontext.fillText ("4",370,h-20);
thecontext.fillText ("50%",350,h-50);
//chart making
thecontext.fillStyle = "pink";
thecontext.fillRect (450,110,60,h-110);
thecontext.fillStyle = "white";
thecontext.fillText ("5",470,h-20);
thecontext.fillText ("60%",450,h-50);
//chart making
thecontext.fillStyle = "green";
thecontext.fillRect (550,65,60,h-65);
thecontext.fillStyle = "white";
thecontext.fillText ("6",570,h-20);
thecontext.fillText ("83%",550,h-50);